...
{
    ConnectionGateKeeper* gatekeeper = new ConnectionGateKeeper(connectionId, _appRegistry, this);
...
{
    _tcpServer->write(connectionId, 0, msg); // TODO: constant for root channel
}
