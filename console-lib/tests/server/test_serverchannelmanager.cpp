...
// -- send messages, expect pingreply
    ...
    manager.processMessageFromSouth(fakeConnectionId, ServerSideControlChannel::ROOT_CHANNEL_ID, pingMsg);
    ...
    ASSERT_EQ(channelId, ServerSideControlChannel::ROOT_CHANNEL_ID);
