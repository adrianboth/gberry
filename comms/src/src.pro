...
CONSOLELIB_BUILD_DIR=$$BUILDS_DIR/build-console-lib-Desktop_Qt_5_4_0_GCC_64bit-Debug/lib
CONSOLELIB_SRC_DIR=$$PROJECTS_ROOT_DIR/gberry-console/console-lib/lib
